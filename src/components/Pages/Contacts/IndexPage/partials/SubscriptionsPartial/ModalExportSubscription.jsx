...
export default class ModalExportContact extends React.Component{
  ...
  componentDidMount() {
    const id = this.props.subscriptions.join(',')
    return API(`subscriptions/export`).post({ mock: true }, {
      id,
    })
    ...
    return (
      <Modal onClose={props.onClose} className="confirmation-modal">
        <form onSubmit={props.onSubmit}>
          <ModalBody>
            <h5><FormattedMessage id="contacts.subscriptions.exportSubscription" /></h5>
