...
export function resetFilters(payload, meta) {
  return {
    type: RESET_FILTERS,
    meta,
    payload,
  ...
  const connectHOC = connect(
    ...
    (dispatch, props) => {
      ...
      const restActions = {
        ...
        resetFilters: payload => resetFilters(payload, meta),
      }
      ...
      return (
        of(
          replace({
            ...
            state: store.getState().router.location.state,
